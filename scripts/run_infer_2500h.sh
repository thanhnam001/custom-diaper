...
# SC_LibriSpeech_2spk_2500h lineage
# (models/10attractors/SC_LibriSpeech_2spk_2500h/) -- the paper's own
# baseline architecture at the paper's Table III data scale. See
...
RUNS=(
    "msdwild_2500h_baseline|${CONFIG_DIR}/infer_msdwild.yaml|0.25"
    "ramc_2500h_baseline|${CONFIG_DIR}/infer_ramc.yaml|"
)
