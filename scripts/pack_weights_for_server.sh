...
#
#   ./scripts/pack_weights_for_server.sh              # required only, ~570 MB
#   MODE=all ./scripts/pack_weights_for_server.sh     # + D1 diagnostics, ~2.8 GB
#
...
# Only read by the D1 diagnostic; skip them if you run RUN_DIAGNOSTICS=0.
DIAGNOSTIC=(
