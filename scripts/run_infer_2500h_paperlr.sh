...
#
# Compare against the SC_LibriSpeech_2spk_2500h sibling's scores
# (MSDWild 19.12, RAMC 23.85) and the paper's published 15.5 / 21.1 --
# this lineage's whole purpose is to close that gap, so these two numbers
# are the experiment's readout. See
...
#   ./scripts/run_infer_2500h_paperlr.sh
...
RUNS=(
    "msdwild_2500h_paperlr|${CONFIG_DIR}/infer_msdwild.yaml|0.25"
    "ramc_2500h_paperlr|${CONFIG_DIR}/infer_ramc.yaml|"
)
